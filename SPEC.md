...
| `<html lang>` と effective lang の同期（v1.2.0 Phase B / C17-09） | `index.html` 内の `applyEffectiveLang()` ヘルパー (I18n.current と `document.documentElement.lang` を同時更新) | useState 初期化 / アカウント切替 useEffect / updateSettings の計 3 箇所から呼出 |
