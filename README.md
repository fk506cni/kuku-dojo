...
- ✅ **v1.3.0**: 多言語対応 Phase C（zh-CN / zh-TW / ko / vi の 4 言語追加 — 初期 6 言語フル展開）。zh-HK/zh-MO/zh-SG など region variant のフォールバックも実装。**4 言語は機械翻訳ベース**で公開し、ネイティブによる改善提案を Issues で募集
